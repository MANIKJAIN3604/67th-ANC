...
const stats = [
  { number: "6000+", label: "DELEGATES" },
  { number: "65+", label: "EVENTS PER YEAR" },
  { number: "30+", label: "COLLABORATIONS" },
  { number: "350+", label: "ASSOCIATE COLLEGES" },
];

const conventionStats = [
  { number: "350+", label: "Universities and Colleges" },
  { number: "1000+", label: "Professional Architects" },
...
function AnnualConventionSection() {
  return (
    <section className="py-20 bg-black">
      <div className="container mx-auto px-4">
        <motion.h2
